...
$query_feed_link=mysql_query("select * from eboo_feeds where status='1' and date(article_pubdate) between '".$yesterday."' and '".$today."'   order by clickcount desc limit ".$limit_skip." , ".$limit_count."  ")or die(insertErrorLogException('application',basename(__FILE__),mysql_error()));
